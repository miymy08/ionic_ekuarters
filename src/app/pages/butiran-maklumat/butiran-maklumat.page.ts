...
@Component({
  selector: 'app-butiran-maklumat',
  templateUrl: './butiran-maklumat.page.html',
  styleUrls: ['./butiran-maklumat.page.scss'],
})
export class ButiranMaklumatPage implements OnInit {
  ...
  loadTask() {
    return new Promise(resolve => {
      ...
      this.provider.postData(body, 'papar_butiranmaklumat.php').subscribe(
        datas => {
