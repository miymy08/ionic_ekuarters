...
@Component({
  selector: 'app-butiran-pasangan',
  templateUrl: './butiran-pasangan.page.html',
  styleUrls: ['./butiran-pasangan.page.scss'],
})
export class ButiranPasanganPage implements OnInit {
  ...
  loadTask(){
    return new Promise(resolve => {
      ...
      this.provider.postData(body, 'papar_butiranpasangan.php').subscribe(
        datas=> {
